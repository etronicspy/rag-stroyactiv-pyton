...
- Сравнить `services/materials.py` (35KB, 886 строк) и `services/materials_consolidated.py` (28KB, 729 строк)
- Оставить актуальную версию
- Удалить устаревшие файлы

#### 2.2 Консолидация API маршрутов
- Объединить `api/routes/materials.py` (2.9KB, 70 строк) и `api/routes/materials_refactored.py` (12KB, 340 строк)
- Оставить только актуальные эндпоинты

### 🟡 ЭТАП 3: ОЧИСТКА ДОКУМЕНТАЦИИ

#### 3.1 Удалить устаревшую документацию
**Файлы для удаления:**
- `STAGE_6_COMPLETION_REPORT.md` (12KB, 193 строки)
- `STAGE_5_COMPLETION_REPORT.md` (29KB, 674 строки)
- `STAGE_4_SUMMARY.md` (19KB, 502 строки)
- `STAGE_3_SUMMARY.md` (6.9KB, 158 строк)
- `REFACTORING_COMPLETED.md` (16KB, 296 строк)
- `REFACTORING_PLAN.md` (19KB, 372 строки)
- `ENVIRONMENT_SETUP.md` (5.1KB, 174 строки)
...
- `demo_advanced_search_simple.py` (24KB, 621 строк)
- `demo_advanced_search.py` (24KB, 620 строк)
- `demo_redis_caching.py` (20KB, 489 строк)
- `demo_postgresql_hybrid.py` (20KB, 460 строк)
- `demo_refactored_service.py` (11KB, 258 строк)

**Работа с данными → utils/data/:**
- `load_materials.py` (9.6KB, 239 строк)
- `load_building_materials.py` (1.0KB, 30 строк)
- `check_loaded_materials.py` (2.7KB, 64 строк)
- `check_db_connection.py` (3.4KB, 98 строк)
- `create_test_data.py` (8.4KB, 165 строк)

**Административные → utils/admin/:**
- `cleanup_collections.py` (8.4KB, 199 строк)
- `export_supplier_prices.py` (14KB, 367 строк)
- `view_collection.py` (5.1KB, 135 строк)
- `show_supplier_prices.py` (12KB, 270 строк)
