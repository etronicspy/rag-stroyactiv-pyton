...
class TestConcreteAIParser(IBaseParser[str, MaterialParseData, dict]):
    """Test concrete implementation of IAIParser"""
    ...
    def get_parser_info(self) -> dict[str, Any]:
        """Test implementation of get_parser_info"""
        return {
            "name": "TestConcreteAIParser",
            "version": "1.0.0",
            "description": "Test AI parser implementation"
        }
...
class TestConcreteMaterialParser(IBaseParser[str, MaterialParseData, dict]):
    """Test concrete implementation of IMaterialParser"""
    ...
    def get_parser_info(self) -> dict[str, Any]:
        """Test implementation of get_parser_info"""
        return {
            "name": "TestConcreteMaterialParser",
            "version": "1.0.0",
            "description": "Test material parser implementation"
        }
